...
public class MD5Utils {
    ...
    /**
     * @param source
     * @param encodeMode 编码格式,如果需要编码的字符串有英文必须使用UTF-8,
     * @return
     */
    public static String toMD5(String source, String encodeMode) {
        String result = "";
        if (source == null) {
            return result;
        }
        byte[] src = null;
        try {
            src = source.getBytes(encodeMode);
    ...
    /**
     * MD5Utils 编码,默认使用 ISO8859_1
     *
     * @param source
     * @return
     */
    public static String toMD5(String source) {
        return toMD5(source, "ISO8859_1");
    }

    public static String toUTF8MD5(String source) {
        return toMD5(source, "UTF-8");
    }


    public final static String convertByteArrayToHexString(byte[] source) {
        if (source != null) {
            int j = source.length;
    ...
    /**
     * 把字符串source用MD5加密成byte数组
     *
     * @param source
     * @return
     */
    public byte[] getMD5Bytes(String source) {
